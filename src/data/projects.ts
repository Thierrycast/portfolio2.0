export const projects = [
   
    {
      ...
      site: "https://github.com/Thierrycast/gabriel-portfolio", 
    ...
    },
    {
      ...
      repo: "Repositório: Insira a URL aqui", 
      site: "https://github.com/Thierrycast/todolist-nest", 
      img: "Imagem: Insira a URL aqui" 
    }, 
    {
      name: "Projeto Fuja",
      description: "Colaboração no desenvolvimento do site para uma empresa de audiovisual, utilizando React, TypeScript e responsividade.",
      repo: "Repositório: Insira a URL aqui", 
